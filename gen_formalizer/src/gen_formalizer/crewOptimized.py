...
class GenFormalizer():
    ...
    def researcher(self) -> Agent:
        return Agent(
            ...
            verbose=True,
            temperature=0.0,  
            llm=LLM(model='gemini/gemini-2.5-flash')#, max_tokens=16000) 
        )
    ...
    def research_task(self) -> Task:
        return Task(
            ...
            description="Solve this math problem efficiently. Provide a clear solution with minimal verbosity. Focus on the correct approach and final answer."
        )
    ...
    def reporting_task(self) -> Task:
        return Task(
            ...
            description="Create a concise report summarizing the solution approach and final answer. Be clear but minimize unnecessary details.",
    ...
    def crew(self) -> Crew:
        ...
        try:
            ...
            print(f"Configuration error: Missing key {e}. Please check your configuration files.")
            raise